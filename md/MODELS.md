...
```bash
python cowork.py --model claude-3-5-sonnet-20241022 --api-key your_key -r "Your task"
```
...
**Configuration Example:**
```bash
python cowork.py --model gpt-4-turbo --api-key your_key -r "Your task"
```
...
**Configuration Example:**
```bash
python cowork.py --model deepseek-chat --api-base https://api.deepseek.com --api-key your_key -r "Your task"
```
...
**Configuration Example:**
```bash
python cowork.py --model kimi --api-base https://api.moonshot.cn/v1 --api-key your_key -r "Your task"
```
...
**Configuration Example:**
```bash
python cowork.py --model Qwen/Qwen2.5-7B-Instruct --api-base https://api.siliconflow.cn/v1 --api-key your_free_key -r "Your task"
```
...
python cowork.py --model MODEL_NAME --api-key YOUR_KEY --api-base API_BASE -r "Task description"
```
...
python cowork.py --model deepseek-chat -r "Start task"
