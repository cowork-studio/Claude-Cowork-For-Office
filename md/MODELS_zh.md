...
**配置示例：**
```bash
python cowork.py --model claude-3-5-sonnet-20241022 --api-key your_key -r "您的任务"
```
...
**配置示例：**
```bash
python cowork.py --model gpt-4-turbo --api-key your_key -r "您的任务"
```
...
**配置示例：**
```bash
python cowork.py --model deepseek-chat --api-base https://api.deepseek.com --api-key your_key -r "您的任务"
```
...
**配置示例：**
```bash
python cowork.py --model kimi --api-base https://api.moonshot.cn/v1 --api-key your_key -r "您的任务"
```
...
**配置示例：**
```bash
python cowork.py --model Qwen/Qwen2.5-7B-Instruct --api-base https://api.siliconflow.cn/v1 --api-key your_free_key -r "您的任务"
```
...
```bash
# 临时使用不同模型
python cowork.py --model MODEL_NAME --api-key YOUR_KEY --api-base API_BASE -r "任务描述"
```
...
```bash
# 当前任务使用 DeepSeek
python cowork.py --model deepseek-chat -r "开始任务"
